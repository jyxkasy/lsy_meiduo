...
urlpatterns = [
    ...
    url(r'^mobile/(?P<mobile>^1[345789]\d{10}/)/count/$', views.MobileCountView.as_view(), name='mobile_count_view'),
    url(r'^image_codes/(?P<uuid>[\w-]+)/$', views.ImageCode.as_view()),
    url(r'^sms_codes/(?P<mobile>^1[345789]\d{10})/$', views.MobileCode.as_view(), name='mobile_code')
